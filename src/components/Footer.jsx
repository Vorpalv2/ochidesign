const Footer = () => {
  return (
    <>
          ...
          <div className=" grid grid-cols-2">
            <div>
              ...
              {["Instagram", "Behance", "Facebook", "Linkedin"].map(
                (element, index) => {
                  return (
                    <h4 className=" underline text-[1vw]" key={index}>
                      <a href="/">{element}</a>
                    </h4>
                  );
                }
            ...
            <div></div>
            <div>
              <h3 className="mb-3 text-[1vw] pt-20">L:</h3>
              {[
                "202-1965 W 4th Ave",
                "Vancouver",
                "30 Chukarina St",
                ...
                return (
                  <div key={index}>
                    <h4 className="underline text-[1vw]">{element}</h4>
                    {index == 1 && <div className="w-full h-[2vh]"></div>}
                  </div>
                );
              })}
            </div>
      ...
      <div className="relative grid grid-cols-3 w-full h-[10vh]">
