const Cards = () => {
  return (
    <div className="w-full h-screen bg-[#212121] rounded-lg flex gap-5 items-center px-32">
      ...
      <div className="relative cardcontainer flex gap-5 w-1/2 h-[50vh]">
        <div className="card flex items-center justify-center rounded-xl w-full h-full bg-[#212121]">
          <img
            ...
            alt="clutch logo"
          />
          <button className="absolute uppercase text-[#77A858] text-xl left-10 bottom-10 px-5 py-1 rounded-full border-2">
        ...
        <div className="relative card flex items-center justify-center rounded-xl w-full h-full bg-[#212121]">
          ...
          />
          <button className="absolute text-[#77A858] text-xl left-10 bottom-10 px-5 py-1 rounded-full border-2 uppercase">
